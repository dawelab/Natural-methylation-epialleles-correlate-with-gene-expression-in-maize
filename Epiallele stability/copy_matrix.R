...
copy_matrix$pan[copy_matrix$min==1 & copy_matrix$max==1]
...
write.table(copy_matrix$pan[copy_matrix$class == "1-1"], 
            "/Users/x/Desktop/Data/core_gene/1-1_pangene.txt",
            quote = F,
            row.names = F, col.names = "pan")
write.table(copy_matrix$pan[copy_matrix$class == "1-N"], 
            "/Users/x/Desktop/Data/core_gene/1-N_pangene.txt",
            quote = F,
            row.names = F, col.names = "pan")
write.table(copy_matrix$pan[copy_matrix$class == "N-N"], 
